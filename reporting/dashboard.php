...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .card-reports   .card-icon { background: rgba(170,136,255,0.1); }
    .card-admin     .card-icon { background: rgba(255,107,53,0.08); }
    ...
    .card-reports   .card-arrow { color: #aa88ff; }
    .card-admin     .card-arrow { color: var(--accent3); }

    .card-sessions:hover   { border-color: var(--accent2); }
    .card-events:hover     { border-color: var(--accent); }
    .card-visualized:hover { border-color: var(--accent3); }
    .card-reports:hover    { border-color: #aa88ff; }
    .card-admin:hover      { border-color: var(--accent3); }

    .card-reports::before { background: linear-gradient(90deg, #aa88ff, var(--accent2)); }
    .card-admin::before   { background: linear-gradient(90deg, var(--accent3), #ff0080); }
...
<div class="page">
  ...
  <div class="cards">
    ...
    <a href="/reports" class="card card-reports">
      <div class="card-icon">⬡</div>
      <div class="card-body">
        <div class="card-title">Saved Reports</div>
        <div class="card-desc">View Exported PDF Reports Generated By Analysts Or Superadmin</div>
      </div>
      <div class="card-arrow">View reports <span>→</span></div>
    </a>
    ...
    <a href="/admin" class="card card-admin">
      ...
      <div class="card-body">
        ...
        <div class="card-desc">Add, Edit, Or Remove Users And Manage Their Roles And Section Access</div>
      </div>
      <div class="card-arrow">Manage users <span>→</span></div>
    </a>
    <?php endif; ?>
